...
@MultipartConfig
@WebServlet("/CreateNewsForUser")
public class CreateNewsForUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/Profile/CreateNews.jsp").forward(request, response);
    }
