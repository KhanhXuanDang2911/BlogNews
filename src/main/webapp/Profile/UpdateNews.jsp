    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<%=request.getContextPath()%>/UpdateNewsForUser" method="POST" enctype="multipart/form-data">
                        <input class="form-control" id="id-news" name="id-news" type="hidden" value="<%=news.getId()%>">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="titleNews" name="title" type="text"
                                   placeholder="Enter title news" value="<%=news.getTitle()%>">
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="contentNews">Content</label>
                            <textarea class="form-control" id="contentNews" name="content" rows="20"><%=news.getContent()%></textarea>
                        </div>
                        <div class="mb-3">
